      ...
      if (reservation) {
        try {
          await sendConfirmationEmail({
            ...
            postalCode: reservation.postal_code ?? undefined,
            prefecture: reservation.prefecture ?? undefined,
            city: reservation.city ?? undefined,
            addressLine: reservation.address_line ?? undefined,
