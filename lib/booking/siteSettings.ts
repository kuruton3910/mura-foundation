...
export type SiteSettings = {
  ...
  max_stay_nights: number; // 連続宿泊の上限（これを超える予約は不可）
...
export const DEFAULT_TERM_GROUPS: TermGroup[] = [
  {
    ...
    terms: [
      "チェックインは11:00〜、チェックアウトは翌11:00までです。",
      "19:00〜翌5:00の間、ゲート内への車の出入りは禁止されています。緊急の場合はスタッフへご連絡ください。",
  ...
  },
  {
    ...
    terms: [
      ...
      "宿泊約款に基づきキャンセル料を頂戴します。詳しくは宿泊約款をお読みください。",
